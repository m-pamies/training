...
$tabela=mysqli_query($acesso->ligacao,
    "SELECT Id_livro,titulo, CONCAT (a.nome, ' ', a.apelido) AS autor , c.nome, volume, g.genero, i.idioma, CONCAT(loc.movel, ' - Prateleira ', loc.prateleira) AS localizacao
    ...
    WHERE la.id_autor LIKE $_POST[txt_id_autor]");
